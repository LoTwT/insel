...
const DataRouterStateContext =
  /* @__PURE__ */ React__namespace.createContext(null)
if (process.env.NODE_ENV !== "production") {
...
function DefaultErrorComponent() {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    devInfo = /* @__PURE__ */ React__namespace.createElement(
...
const defaultErrorElement = /* @__PURE__ */ React__namespace.createElement(
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    return dataRouterState &&
      ...
      ? /* @__PURE__ */ React__namespace.createElement(RenderErrorBoundary, {
...
new Promise(() => {})
const A = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Route A" })
}
const B = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Route B" })
}
const Index = () => {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Route Index" })
}
const routes = [
  {
    path: "/guide",
...
function render() {
  return server.renderToString(
    /* @__PURE__ */ jsxRuntime.jsx(StaticRouter, {
      location: "/guide",
